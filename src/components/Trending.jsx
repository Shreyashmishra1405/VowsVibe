const Trending = () => {
  return (
    <div className="flex flex-col gap-4  justify-center items-center my-6 px-4 md:px-20 overflow-hidden ">
      ...
      >
        ...
        <div className="flex flex-row gap-4 ">
          <div className="flex flex-col ">
            <div className="relative   h-[200px]  text-[#2D2D2D]">
              ...
              <div className="absolute top-4 left-0 px-4 text-xs bg-[#A40303] text-white rounded-r-2xl">
                BestSeller
              </div>
            </div>
            <div>
              <span className="text-xs md:text-sm">Rose Gold Earrings with alloy</span>
              <div className="flex flex-row gap-2 items-center font-medium">
                <span className="text-xs   md:text-sm font-semibold">₹1999</span>
                <span className="line-through text-xs  md:text-sm">₹2999</span>
              </div>
            </div>
            <button className="py-2 px-8 bg-[#CA8787] text-xs md:text-sm text-white cursor-pointer w-full">
              Move to Bag
            </button>
          </div>
        </div>
